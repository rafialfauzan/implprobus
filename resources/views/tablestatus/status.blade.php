        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-5">
                        <a href="{{ route('createstatus') }}" class="bg-white font-bold text-black px-2 py-2 rounded-md border-black border-solid border-2 hover:bg-black hover:text-white transition delay-50 duration-300"><i class="fa-solid fa-plus"></i> Buat status baru</a>
                    </div>
                    <div class="mt-5">
                        <div class="my-10">
                            <p class="text-center text-xl font-bold">List Status</p>
                        </div>
